...
@InputType()
class ModificationCreateNestedManyWithoutPartsInput {
...
export { ModificationCreateNestedManyWithoutPartsInput as ModificationCreateNestedManyWithoutPartsInput };
